...
class KaKaoTalkForm(forms.Form):
    ...
    web_url=forms.CharField(label='Web URL',max_length=300,initial='http://192.168.219.105:8000/mjpeg')
    mobile_web_url = forms.CharField(label='Mobile Url', max_length=300,initial='http://192.168.219.105:8000')
    def send_talk(self):
